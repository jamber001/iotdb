...
public class MManagerAdvancedTest {
  ...
  public void test() {
    ...
    try {
      ...
      pathList = mmanager.getAllTimeseriesPaths(new PartialPath("root.vehicle.d0"));
      assertEquals(6, pathList.size());
      pathList = mmanager.getAllTimeseriesPaths(new PartialPath("root.vehicle.d*"));
      assertEquals(12, pathList.size());
      pathList = mmanager.getAllTimeseriesPaths(new PartialPath("root.ve*.*"));
      assertEquals(12, pathList.size());
      pathList = mmanager.getAllTimeseriesPaths(new PartialPath("root.vehicle*.d*.s1"));
      assertEquals(2, pathList.size());
      pathList = mmanager.getAllTimeseriesPaths(new PartialPath("root.vehicle.d2"));
